...
<div id="pwa-install-bar" style="display:none;position:fixed;bottom:0;left:0;right:0;background:var(--card,#1a1a2e);border-top:1px solid rgba(168,85,247,.3);padding:12px 16px;align-items:center;gap:12px;z-index:9999;box-shadow:0 -2px 12px rgba(0,0,0,.4)">
    <div style="flex:1;min-width:0">
        <div style="font-size:.9rem;font-weight:600;color:var(--txt,#e5e5e5)">Install SoulSync Admin</div>
