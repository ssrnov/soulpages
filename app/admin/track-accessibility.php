...
// ═══════════════════════════════════════════════════════════
// DATA QUERIES — all computed server-side from existing tables
// ═══════════════════════════════════════════════════════════
...
// Device snapshots for ringer/vol changes
$snapshots = [];
...
// Second space / dual app detection (from installed_apps)
$cloneApps = [];
try {
...
// Screen recording apps detection
$recorderApps = [];
try {
...
// Incognito hint: browser running but check for private browsing class names
$incognitoHints = [];
try {
