...
$PAGE_TOOLS = '<form method="get" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap"><input type="hidden" name="user" value="'.$uid.'"><input class="sel" type="text" name="q" value="'.ss_admin_h($q).'" placeholder="Search app / package" style="min-width:180px"></form>';
...
<?php if(!$uid): ?>
  <div class="panel"><div class="empty">No tracking access for this user.</div></div>
<?php else: ?>
