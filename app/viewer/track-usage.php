...
$PAGE_SUB   = 'How time is spent across applications';
$PAGE_ICON  = '📱';
...
$PAGE_TOOLS = '<form method="get" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap"><input type="hidden" name="user" value="'.$uid.'"><input class="sel" type="date" name="day" value="'.ss_admin_h($day).'" max="'.date('Y-m-d').'" min="'.date('Y-m-d', strtotime('-30 days')).'" onchange="this.form.submit()"></form><a class="btn" href="?user='.$uid.'&day='.ss_admin_h($day).'&export=csv">⬇ CSV</a>';
...
<?php endif; require __DIR__ . '/_foot_viewer.php';
