...
try {
    ...
    // Website download button uses its own link first, then the app-update link.
    $du = ss_setting($pdo, 'web_download_link', '');
    if ($du === '') $du = ss_setting($pdo, 'download_url', '');
    if ($du) $dlUrl = $du;
